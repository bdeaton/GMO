...
(function( $ ){
  $.fn.spinningGlobe = function( options ) {  
		...
		options.pointsHtml = options.pointsHtml;
		...
		var methods = {
			...
			init : function( ) { 
				...
				'<div class="earth-foreground" style="position:absolute; top: 1px; left: 1px; overflow: hidden; width:'+options.earthBoundingWidth+'px; height:'+options.earthBoundingWidth+'px;">'+
					...
					'<div class="map-points-container map-points-foreground" id="map-points-foreground" style="position: absolute; left: -'+options.earthWidthHalf+'px; top: 0px; height: '+options.imageHeight+'px; width: '+options.imageWidth+'px;">'+options.pointsHtml+
					'</div>'+
				'</div>'+
				'<div class="globe-foreground" style="position:absolute; top: 0; left: 0;">'+
					'<img src="'+options.prefix+'globe_foreground.png" width="'+options.imageHeight+'" height="'+options.imageHeight+'" />'+
				'</div>'+
				'</div>';
